/* MIDI playback through camd.library - taken from the AmigaOS port of OpenTTD 1.0.5
 * (same author); used by the Master of Magic port since 0.3.0.
 *
...
int AmigaMidi_Start(void)
{
	...
	g_midi_node = CreateMidi(MIDI_Name, (Tag)"Master of Magic",
